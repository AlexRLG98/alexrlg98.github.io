...
export const ctfCompetitions: Competition[] = [
  {
    ...
    highlights: [
      ...
      },
      {
        ...
        en: 'CTF / AI (Airbus & Google) - CTF challenges with AI component'
      },
      {
        fr: 'Forensic (EPITA) - Investigation numérique et analyse de traces',
        en: 'Forensic (EPITA) - Digital investigation and trace analysis'
      },
      {
        fr: 'Roster flottant de 10 joueurs, 5 max par épreuve selon spécialités - Présentiel BYOD au Lille Grand Palais',
  ...
  },
  {
    ...
    highlights: [
      {
        fr: '1er ex-aequo (8ème) sur 187 équipes - Égalité 1ère place avec 19 équipes',
        en: '1st tied (8th) out of 187 teams - Tied for 1st place with 19 teams'
      },
      {
        fr: '5567 points (1417 perso) - Qualifié pour la finale ESIEE Paris',
        en: '5567 points (1417 personal) - Qualified for ESIEE Paris final'
      },
      {
        fr: 'Équipe SimianSec (6 membres)',
  ...
  },
  {
    ...
    highlights: [
      {
        fr: '7ème sur 270 équipes Students',
