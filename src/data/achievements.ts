...
export const ctfCompetitions: Competition[] = [
  {
    ...
    highlights: [
      {
        fr: '1ère place actuelle - 6717 points',
        en: '1st place currently - 6717 points'
      },
      {
      ...
      {
        fr: '18 challenges résolus en 2h',
        en: '18 challenges solved in 2h'
      },
      {
        fr: 'Format flag : RUSEC{}',
        en: 'Flag format: RUSEC{}'
      }
    ],
